...
import CachedBoard from '../../src/logics/CachedBoard';
import classic from '../../src/themes/classic';

describe('[class] CachedBoard (without theme)', () => {
  beforeEach(() => {
    this.board = new CachedBoard();
  });
...
describe('[class] CachedBoard (with classic theme)', () => {
  beforeEach(() => {
    this.board = classic(new CachedBoard());
  });
